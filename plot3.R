...
mydata$Global_active_power <- as.double(mydata$Sub_metering_3)
mydata$Global_active_power <- as.double(mydata$Sub_metering_2)
mydata$Global_active_power <- as.double(mydata$Sub_metering_1)
